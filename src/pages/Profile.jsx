...
const Profile = () => {
  return (
    <div className=''>
      <section class='flex justify-center items-center min-h-screen bg-gradient-to-br from-purple-900 via-indigo-800 to-blue-900 p-4 '>
        {/* <!-- Profile Card Container --> */}
        <div class='max-w-md w-full bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl transform hover:scale-[1.02] transition-transform duration-500 ease-in-out p-8 relative overflow-hidden border border-white/20'>
          {/* <!-- Decorative Elements --> */}
          <div class='absolute -top-20 -right-20 w-40 h-40 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl opacity-70'></div>
          <div class='absolute -bottom-20 -left-20 w-40 h-40 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-70'></div>

          {/* <!-- Glow Effect --> */}
          <div class='absolute inset-0 bg-gradient-to-br from-purple-400/10 via-transparent to-blue-400/10 rounded-3xl'></div>

          {/* <!-- Profile Image with Floating Effect --> */}
          <div class='flex justify-center -mt-20 mb-6 relative z-10 mt-5'>
            <div class='relative group'>
              <div class='absolute inset-0  bg-gradient-to-br from-purple-400 to-pink-500 rounded-full blur-md group-hover:blur-lg transition-all duration-500'></div>
              <img
                class='w-40 h-40 object-cover rounded-full border-4 border-white/80 shadow-xl hover:scale-105 transform transition-all duration-400 relative z-10'
          ...
          <div class='text-center mb-6 relative z-10'>
            <h2 class='text-3xl font-bold text-white mb-2 tracking-tight'>
              <span class='relative inline-block'>
                ...
                <span class='absolute bottom-0 left-0 w-full h-1 bg-gradient-to-r from-purple-400 to-pink-500 rounded-full transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left'></span>
              </span>
            </h2>
            <p class='text-lg font-medium text-purple-200 tracking-wider'>
              UI/UX Designer & Developer
            </p>
          </div>

          {/* <!-- Description with Fade-in Effect --> */}
          <p class='text-center text-white/80 mb-8 px-6 relative z-10 transition-all duration-500 hover:text-white'>
          ...
          <div class='flex justify-center space-x-6 relative z-10'>
            ...
            <a
              href='#'
              class='p-3 rounded-full bg-white/5 backdrop-blur-sm shadow-lg hover:bg-blue-500/30 transition-all duration-300 group'>
              <svg
                class='w-6 h-6 text-white/80 group-hover:text-blue-400 group-hover:scale-110 transition-all duration-300'
                fill='currentColor'
                viewBox='0 0 24 24'>
            ...
            <a
              href='#'
              class='p-3 rounded-full bg-white/5 backdrop-blur-sm shadow-lg hover:bg-blue-600/30 transition-all duration-300 group'>
              <svg
                class='w-6 h-6 text-white/80 group-hover:text-blue-300 group-hover:scale-110 transition-all duration-300'
                fill='currentColor'
                viewBox='0 0 24 24'>
            ...
            <a
              href='#'
              class='p-3 rounded-full bg-white/5 backdrop-blur-sm shadow-lg hover:bg-purple-500/30 transition-all duration-300 group'>
              <svg
            ...
            <a
              ...
              <svg
                class='w-6 h-6 text-white/80 group-hover:text-pink-300 group-hover:scale-110 transition-all duration-300'
                fill='currentColor'
                viewBox='0 0 24 24'>
          ...
          <div class='mt-8 text-center relative z-10'>
            <button class='px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-medium rounded-full shadow-lg hover:shadow-xl hover:from-purple-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105'>
              Contact Me
            </button>
          </div>
        </div>
